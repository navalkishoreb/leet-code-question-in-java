        ...
        public int[] exclusiveTime(int n, List<String> logs) {
            ...
            for (String log : logs) {
                ...
                if (action.equals("start")) {
                    if (!stack.isEmpty()) {
                        // not +1 as start time is for new function
                        // for previous function it was removed in previous time unit
                    ...
                    // +1 as end time is inclusive
                    res[currentFunc] += (timestamp - prevTimestamp) + 1;
