        ...
        public boolean isValid(String s) {
            ...
            for (char ch : s.toCharArray()) {
                ...
                if (ch == '(') stack.push(')');
                    ...
                    // if stack cannot be empty when we receive a closing symbol
                    // if there are element in stack
                    // then last element should match the current closing symbol
                    if (stack.isEmpty() || stack.pop() != ch) {
                        return false;
                    }
                }
            }
            // at the end all parentheses should been covered
            // and stack should have become empty
